...
<form action="config/code_types.php" method="POST" enctype="multipart/form-data" style="padding:20px;">
...
<div class="card">
              <div class="card-header">
                ...
                <a href="#" data-toggle="modal" data-target="#ProModal" class="btn btn-success float-right" >Add Types</a>
              </div>
...
if($check_result){
  while( $rows = mysqli_fetch_array( $data ) ) 
  {
      ?>
                    ...
                    <td><a href="type_update.php?id=<?php echo $rows ['id']?>"  class="btn btn-primary" >Update</a>
