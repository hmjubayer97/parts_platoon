...
<div class="card">
              <div class="card-header">
                <h3 class="card-title">Type Update:</h3>

                <a href="type_read.php"  class="btn btn-primary float-right" >Back</a>
              </div>
...
<a href="type_read.php"><button type="button" class="btn btn-secondary" > View Typess</button></a>
<button type="submit" name="update" class="btn btn-primary">Update Type</button>
</div>
